 ...
 <form id="itemForm" action="${pageContext.request.contextPath }/updateitem" method="post">
  ...
  <table class="table table-bordered">
   ...
   <tr>
    <td>商品生产日期</td>
    <td>
     <input class="form-control" type="text" name="createtime" value="<fmt:formatDate value="${item.createtime}" pattern="yyyy-MM-dd HH:mm:ss"/>" />
    </td>
   </tr>
   <%-- 
			<tr>
   ...
   <tr>
    <td>商品简介</td>
    <td>
     <textarea class="form-control" rows="3" cols="30" name="detail">${item.detail }</textarea>
    </td>
   </tr>
   <tr>
