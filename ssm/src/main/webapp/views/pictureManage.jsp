...
<link rel="stylesheet" href="${pageContext.request.contextPath}/public/css/uploadify.css" type="text/css"></link>
...
<script type="text/javascript">
	...
	function openPictureModifyDialog() {
		...
		$('#fm').form('load', row);
		url = "${pageContext.request.contextPath}/picture/save?id=" + row.id;
	}
	...
	function initUploadify() {
		$("#uploadify2").uploadify({
			...
			'script' : '../loadimg/upload', //后台处理程序的路径
